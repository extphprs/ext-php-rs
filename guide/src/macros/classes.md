...
**Note:** On PHP versions before 8.2, the `readonly` attribute is silently ignored
for backwards compatibility. Your extension will still work, but the class won't
have the readonly enforcement that PHP 8.2+ provides.
