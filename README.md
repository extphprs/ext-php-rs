...
- [php-hardened-rs](https://github.com/kakserpom/php-hardened-rs) - Security utilities for PHP written in Rust.
- [php-sqlx-rs](https://github.com/kakserpom/php-sqlx-rs) - A modern feature-rich SQL driver for PHP.
