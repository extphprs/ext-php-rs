...
pub const ZEND_MM_ALIGNMENT: isize = 8;
pub const ZEND_MM_ALIGNMENT_MASK: isize = -8;
...
unsafe extern "C" {
    ...
    pub fn ext_php_rs_pemalloc_persistent(size: usize) -> *mut c_void;
    pub fn ext_php_rs_zend_string_init_persistent_interned(
        str_: *const c_char,
        len: usize,
    ) -> *mut zend_string;
